        ...
        if let Some(encoded) = symbol.strip_prefix("expr:") {
            ...
            let values = encoded
                ...
                .map(|token| match token {
                    ...
                    "rsub" => Some(NumericValue::Operation(NumericOp::ReverseSubtract)),
                    "*" => Some(NumericValue::Operation(NumericOp::Multiply)),
                    "/" => Some(NumericValue::Operation(NumericOp::Divide)),
                    "rdiv" => Some(NumericValue::Operation(NumericOp::ReverseDivide)),
                    ...
                    "setunion" => Some(NumericValue::SetUnion),
                    "setintersection" => Some(NumericValue::SetIntersection),
                    "setdifference" => Some(NumericValue::SetDifference),
                    "setsymmetricdiff" => Some(NumericValue::SetSymmetricDifference),
                    ...
                    "rpow" => Some(NumericValue::ReversePower),
                    "%" => Some(NumericValue::Remainder),
                    "rrem" => Some(NumericValue::ReverseRemainder),
