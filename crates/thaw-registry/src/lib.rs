...
mod tests {
    ...
    fn worker_threads_load_runtime_computed_absolute_paths() {
        ...
        fs::write(
            ...
            r#"{"main":"wrong.cjs","exports":{".":{"node":"./entry.cjs","default":"./wrong.cjs"},"./feature":{"require":"./feature.js"}}}"#,
        )
        .unwrap();
        fs::write(
