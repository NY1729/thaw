...
"#,
        ...
        "stream" => Some(
            "function Stream() { this._events = Object.create(null); this.destroyed = false; this.errored = null; this._readableDidRead = false; }\n\
             ...
             function Readable(options) { Stream.call(this); options = options || {}; this.readable = true; this.readableEnded = false; this.readableEncoding = null; this.readableHighWaterMark = Math.max(1, Number(options.highWaterMark || (options.objectMode || options.readableObjectMode ? 16 : 16384))); this.readableLength = 0; this._readableObjectMode = Boolean(options.objectMode || options.readableObjectMode); this._paused = false; this._chunks = []; this._read = typeof options.read === 'function' ? options.read : function() {}; }\
