...
pub type PromiseTransformFn =
    extern "C" fn(*mut u8, *mut ThawPromise, *mut ThawPromise, *const u8);
pub type PromiseFinallyFn =
    extern "C" fn(*mut u8, *mut ThawPromise, *mut ThawPromise, *const u8, u8);
